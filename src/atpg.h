...
class ATPG {
 public:
  ...
  void NOPrint_transition_delay_fault_simulation(int &);
  //
 ...
 private:
  ...
  //2020-week13 modify
  void Fk_atpg(forward_list<fptr> &);
  //
  ...
  //2020-week13 modify
  forward_list<fptr> TFMD;
  
  void TFMD_transition_delay_fault_simulation(int &, int &, forward_list<fptr> &);
  void TFMD_tdfault_sim_a_vector(const string &, int &, forward_list<fptr> &);
  void TFMD_tdfault_sim_a_vector2(const string &, int &, forward_list<fptr> &);
  //
  ...
  //2020-week13 modify
  bool tdfatpg_only;
  bool tdf_sim_vector(const string&, fptr);
  //
